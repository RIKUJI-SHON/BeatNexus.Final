...
BEGIN
  ...
  LOOP
    ...
    WHERE s2.status = 'WAITING_OPPONENT'
      ...
      -- 🛡️ 重複バトル防止: 48時間以内に同じ相手との対戦履歴がないことを確認
      AND NOT EXISTS (
...
SELECT '⚡ より短い待ち時間でのマッチング実現' as improvement;
