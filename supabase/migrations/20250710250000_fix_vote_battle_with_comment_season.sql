...
-- コメント付き投票でもseason_idとseason_vote_pointsが正しく設定されるように
...
COMMENT ON FUNCTION public.vote_battle_with_comment(uuid, char, text) IS 'v2 (Season Support): Handles voting with comments and proper season_id assignment and season points increment.';
