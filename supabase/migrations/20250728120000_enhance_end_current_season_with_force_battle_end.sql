-- Migration: シーズン終了時アクティブバトル強制終了機能の実装
-- Created: 2025-07-28
-- Description: end_current_season関数にアクティブバトル強制終了機能を追加

-- 拡張されたend_current_season関数の実装
...
-- マイグレーション情報をコメントとして記録
COMMENT ON FUNCTION public.end_current_season() IS 'シーズン終了処理関数（v2.0）- アクティブバトル強制終了機能付き。2025-07-28に拡張実装。';
