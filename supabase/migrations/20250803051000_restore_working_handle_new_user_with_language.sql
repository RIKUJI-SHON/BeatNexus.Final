-- 正常動作するhandle_new_user関数を復元（言語設定機能付き）
-- 過去のデータベースから取得した動作確認済みの実装をベースに、言語機能を追加
...
BEGIN
  ...
  RAISE NOTICE 'handle_new_user function restored successfully with language support';
END $$;
